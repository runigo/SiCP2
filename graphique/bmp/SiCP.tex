...
%
  \begin{scope}[xshift=-5.5 cm,yshift=1.1cm]
    \node[scale=\scl] at (5.9,3.3) {\LARGE \textbf{Simulation}};
    \fill[blue!50!black!20!,draw=black,thick,rounded corners] (2.9,1.5)-- (2.9,2.5)-- (2.1,2.0)-- cycle;
    \fill[blue!50!black!20!,draw=black,thick,rounded corners] (3.2,1.5)-- (3.2,2.5)-- (2.4,2.0)-- cycle;
    \fill[blue!50!black!20!,draw=black,thick,rounded corners] (4.5,1.5)-- (4.5,2.5)-- (3.7,2.0)-- cycle;
    ...
    \fill[blue!50!black!20!,draw=black,thick,rounded corners] (8.0,2.0)-- (7.2,1.5)-- (7.2,2.5)-- cycle;
    \fill[blue!50!black!20!,draw=black,thick,rounded corners] (9.6,2.0)-- (8.8,1.5)-- (8.8,2.5)-- cycle;
    \fill[blue!50!black!20!,draw=black,thick,rounded corners] (9.3,2.0)-- (8.5,1.5)-- (8.5,2.5)-- cycle;
