...
%        ECRAN
%
    \fill[white,draw=black,thick](-21,-4.4) rectangle (28,30.9);
...
%   ENERGIE
  \begin{scope}[xshift=-16.7 cm,yshift=\hauteur cm]
    ...
    \fill[red!35](-3.3,6.1) rectangle (-0.1,6.9);
    \node[scale=1.0] at (-1.65,6.5) {$Cin\acute{e}tique$};
    \fill[blue!30](-3.2,5.2) rectangle (-0.1,6.05);
    \node[scale=1.0] at (-1.60,5.6) {$Couplage$};
    \fill[green!40](-3.9,4.4) rectangle (-0.1,5.15);
    \node[scale=1.0] at (-1.95,4.8) {$Gravitation$};
  \end{scope}
%   ENERGIE
  \begin{scope}[xshift=1.3 cm,yshift=\hauteur cm]
    ...
    \draw [<->,draw=gray,thick] (0,7) node (yaxis) [above] {$\acute{E}nergie$}
        |- (16,0) node (xaxis) [right] {$t$};
    \fill[red!35](-2.3,6.1) rectangle (-0.1,6.9);
    \node[scale=1.0] at (-1.2,6.5) {$Totale$};
    \fill[blue!30](-2.7,5.2) rectangle (-0.1,6.05);
    \node[scale=1.0] at (-1.40,5.6) {$Gauche$};
    \fill[green!40](-2.4,4.4) rectangle (-0.1,5.15);
    \node[scale=1.0] at (-1.25,4.8) {$Droite$};
  \end{scope}
%
%
%      PANNEAU  BAS
%
  \fill[panneaucontroles] (-20.5,-4.0) rectangle (19.6,0.7);
%
    \def\hauteur{-3.8}
%
%       Rotation de la chaîne
  \begin{scope}[xshift=-21.5 cm,yshift=\hauteur cm]
    ...
    \fill[lumiereeteinte] (2.8,0.8) circle (0.3cm);
    \fill[lumiereeteinte] (4.2,0.8) circle (0.3cm);
...
%       Vitesse de la simulation
  \begin{scope}[xshift=-11.5 cm,yshift=\hauteur cm]
...
%
%       Réinitialisaation
  \begin{scope}[xshift=3.5 cm,yshift=\hauteur cm]

  %panneaucontroles/.style={yellow!30!brown!20!,rounded corners,,thick},
  \draw[blue,rounded corners,thin] (-0.6,0.2) rectangle (15.8,4.0);
    ...
    \node[scale=\scl] at (12.5,3.3) {\Large \textbf{Nombre / 100}};
